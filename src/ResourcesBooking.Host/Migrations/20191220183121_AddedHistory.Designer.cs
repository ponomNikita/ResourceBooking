...
namespace ResourcesBooking.Host.Migrations
{
    ...
    [Migration("20191220183121_AddedHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResourcesBooking.Host.Models.HistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ResourcesBooking.Host.Models.HistoryEntry", b =>
                {
                    b.HasOne("ResourcesBooking.Host.Models.Resource", "Resource")
                        .WithMany()
                        .HasForeignKey("ResourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ResourcesBooking.Host.Models.User", "User")
                        .WithMany()
